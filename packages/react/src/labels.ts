 ...
 * actual colors.
 *
 * Note the React adapter treats `--sld-pos` as a **complete CSS color**
 * (`var(--sld-pos)`), not the HSL triplet the Svelte/Tailwind-v3 adapter
 * expects — see `packages/README.md`, "One intentional styling divergence".
 */
